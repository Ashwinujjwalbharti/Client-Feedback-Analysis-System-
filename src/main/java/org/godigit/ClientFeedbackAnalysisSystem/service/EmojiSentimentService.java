...
public class EmojiSentimentService {
    ...
    private final String API_KEY = "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"; // Replace with your actual key
    ...
    public String analyzeEmojiSentiment(String text) {
        ...
        headers.setAccept(List.of(MediaType.APPLICATION_JSON)); // Important fix
